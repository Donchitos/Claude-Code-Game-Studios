# Story 001: In-Memory Queue Operations (enqueue/dequeue)
...
- [x] See GDD `design/gdd/matchmaking-engine.md` §8 Acceptance Criteria for this story
...
**Story Type**: Logic
**Required evidence**: `tests/unit/matchmaking-engine/matchmaking_engine_test.ts`
