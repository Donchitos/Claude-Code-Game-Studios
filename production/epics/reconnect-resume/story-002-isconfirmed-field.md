# Story 002: isConfirmed in reconnect_ack

> **Epic**: reconnect-resume
> **Status**: Complete
> **Layer**: Core
> **Type**: Logic
> **Estimate**: S
...
- [x] See GDD `design/gdd/reconnect-resume.md` §8 Acceptance Criteria for this story
...
**Story Type**: Logic
**Required evidence**: `tests/unit/reconnect-resume/reconnect_resume_test.ts`
