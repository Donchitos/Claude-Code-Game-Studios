# Story 001: Bot Decision Loop (move + target)
...
- [x] See GDD `design/gdd/bot-ai.md` §8 Acceptance Criteria for this story
...
**Story Type**: Logic
**Required evidence**: `tests/unit/bot-ai/bot_ai_test.ts`
