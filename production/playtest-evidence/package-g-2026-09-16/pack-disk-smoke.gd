...
func _run():
	...
	assert(OS.get_user_data_dir().contains("Spirit Nexus G 20260916"))
	...
	root.get_texture().get_image().save_png("/Users/tal/CursorProjects/xiuxian/Claude-Code-Game-Studios/production/playtest-evidence/package-g-2026-09-16/pack-disk-smoke.png")
	game.queue_free()
	await process_frame
	await process_frame
