...
func run():
 ...
 for spec in [[24,"zh-CN",1280],[25,"en",1280],[31,"en",1280],[39,"en",1280],[47,"en",1280],[55,"en",1280],[62,"zh-CN",1280],[63,"en",1280],[24,"zh-CN",960],[24,"en",960],[63,"zh-CN",960],[63,"en",960]]:
  ...
  root.get_texture().get_image().save_png("/tmp/late-ui-%d-%s-%d.png"%[index,spec[1],spec[2]])
