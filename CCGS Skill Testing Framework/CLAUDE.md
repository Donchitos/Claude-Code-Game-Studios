...
| File | Purpose |
|------|---------|
| `catalog.yaml` | Coverage registry for 73 skill specs and 49 agent specs. Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. |
