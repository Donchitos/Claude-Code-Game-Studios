...
2. Read the skill at `skills/[name]/SKILL.md` (or `roles/[name].md` for role-profile tests)
...
Nothing in the main plugin imports from here. Deleting this folder has no effect on the
