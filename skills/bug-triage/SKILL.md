...
- Canonical syntax: `$bug-triage`
- Expected input: `[sprint | full | trend]`. Input is the text supplied by the user's invoking prompt.
...
Search for bug reports in priority order:
