...
- Canonical syntax: `$project-stage-detect`
- Expected input: `[optional: role filter like 'programmer' or 'designer']`. Input is the text supplied by the user's invoking prompt.
