...
- Canonical syntax: `$tech-debt`
- Expected input: `[scan|add|prioritize|report]`. Input is the text supplied by the user's invoking prompt.
...
Then pause and ask the user a focused question to collect the **category**:
...
Then pause and ask the user a focused question to collect the **estimated fix effort**:
