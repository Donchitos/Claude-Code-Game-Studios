...
- Canonical syntax: `$test-helpers`
- Expected input: `[system-name | all | scaffold]`. Input is the text supplied by the user's invoking prompt.
...
```
rg --files tests -g "*_test.*" (all test files)
```
