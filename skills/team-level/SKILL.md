...
- Canonical syntax: `$team-level`
- Expected input: `[level name or area to design] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
- [narrative-director](../../roles/narrative-director.md) role profile — Narrative purpose, characters, emotional arc
- [world-builder](../../roles/world-builder.md) role profile — Lore context, environmental storytelling, world rules
- [level-designer](../../roles/level-designer.md) role profile — Spatial layout, pacing, encounters, navigation
- [systems-designer](../../roles/systems-designer.md) role profile — Enemy compositions, loot tables, difficulty balance
- [art-director](../../roles/art-director.md) role profile — Visual theme, color palette, lighting, asset requirements
- [accessibility-specialist](../../roles/accessibility-specialist.md) role profile — Navigation clarity, colorblind safety, cognitive load
- [qa-tester](../../roles/qa-tester.md) role profile — Test cases, boundary testing, playtest checklist
...
Spawn all three agents simultaneously — issue all three generic sub-agent requests before waiting for any result.
...
**Gate**: Pause and ask the user a focused question to present all three Step 1 outputs (narrative brief, lore foundation, visual direction targets) and confirm before proceeding to Step 2.
...
**Gate**: Pause and ask the user a focused question to present Step 2 layout (including any unresolved adjacent area dependencies) and confirm before proceeding to Step 3.
...
**Gate**: Pause and ask the user a focused question to present Step 3 outputs and confirm before proceeding to Step 4.
...
**Gate**: Pause and ask the user a focused question to present both Step 4 results. If the accessibility-specialist returned any BLOCKING concerns, highlight them prominently and offer:
...
After all subagent outputs are collected, spawn `level-designer` through generic sub-agent delegation to compile and write the final document:
