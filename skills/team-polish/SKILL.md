...
- Canonical syntax: `$team-polish`
- Expected input: `[feature or area to polish] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
- [tools-programmer](../../roles/tools-programmer.md)

If no argument is provided, output usage guidance and exit without spawning any agents:
> Usage: `$team-polish [feature or area]` — specify the feature or area to polish (e.g., `combat`, `main menu`, `inventory system`, `level-1`). Do not pause and ask the user a focused question here; output the guidance directly.
...
- [performance-analyst](../../roles/performance-analyst.md) role profile — Profiling, optimization, memory analysis
- [engine-programmer](../../roles/engine-programmer.md) role profile — Engine-level fixes for rendering, memory, resource loading
- [technical-artist](../../roles/technical-artist.md) role profile — VFX polish, shader optimization, visual quality
- [sound-designer](../../roles/sound-designer.md) role profile — Audio polish, mixing, ambient layers
- [tools-programmer](../../roles/tools-programmer.md) role profile — Content pipeline and editor tool verification
- [qa-tester](../../roles/qa-tester.md) role profile — Edge case testing, regression testing, soak testing
