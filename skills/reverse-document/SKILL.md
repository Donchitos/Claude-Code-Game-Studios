...
- Canonical syntax: `$reverse-document`
- Expected input: `<type> <path> (e.g., 'design src/gameplay/combat' or 'architecture src/core')`. Input is the text supplied by the user's invoking prompt.
