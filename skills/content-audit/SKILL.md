...
- Canonical syntax: `$content-audit`
- Expected input: `[system-name | --summary | (no arg = full audit)]`. Input is the text supplied by the user's invoking prompt.

## Role

Adopt the [producer](../../roles/producer.md) profile locally when running this skill, or inject that profile into the prompt for a generic Codex sub-agent. The profile provides repository guidance; it is not a registered custom agent type.
...
2. **L0 pre-scan**: Before full-reading any GDDs, search all GDD files with `rg` for
   `## Summary` sections plus common content-count keywords:
   ```
   rg -l "(## Summary|N enemies|N levels|N items|N abilities|enemy types|item types)" design/gdd -g "*.md"
   ```
...
what has been implemented. Use `rg --files` and `rg` to locate files and matching content.

**Levels / Areas / Maps:**
- Enumerate `assets/**/*.tscn`, `assets/**/*.unity`, `assets/**/*.umap`
- Enumerate `src/**/*.tscn`, `src/**/*.unity`
...
- Enumerate `assets/data/**/enemies/**`, `assets/data/**/characters/**`
- Enumerate `src/**/enemies/**`, `src/**/characters/**`
...
- Enumerate `assets/data/**/items/**`, `assets/data/**/equipment/**`,
  `assets/data/**/loot/**`
- Look for `.json`, `.tres`, `.asset` data files

**Abilities / Skills / Spells:**
- Enumerate `assets/data/**/abilities/**`, `assets/data/**/skills/**`,
  `assets/data/**/spells/**`
- Look for `.json`, `.tres`, `.asset` data files

**Dialogue / Conversations / Cutscenes:**
- Enumerate `assets/**/*.dialogue`, `assets/**/*.csv`, `assets/**/*.ink`
- Search for dialogue data files in `assets/data/`

**Quests / Missions:**
- Enumerate `assets/data/**/quests/**`, `assets/data/**/missions/**`
