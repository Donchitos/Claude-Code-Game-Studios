...
- Canonical syntax: `$team-live-ops`
- Expected input: `[season name or event description] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
- [live-ops-designer](../../roles/live-ops-designer.md)
...
- [live-ops-designer](../../roles/live-ops-designer.md) role profile — Season/event structure and retention mechanics
- [economy-designer](../../roles/economy-designer.md) role profile — Live economy balance and reward pricing
- [analytics-engineer](../../roles/analytics-engineer.md) role profile — Success metrics, A/B tests, event instrumentation
- [community-manager](../../roles/community-manager.md) role profile — Player-facing communication and messaging
- [narrative-director](../../roles/narrative-director.md) role profile — Seasonal theme and narrative framing
- [writer](../../roles/writer.md) role profile — All player-facing text: event descriptions, item names, copy
...
delegated to sub-agents spawned through generic sub-agent delegation. Each sub-agent enforces the
