...
- Canonical syntax: `$quick-design`
- Expected input: `[brief description of the change]`. Input is the text supplied by the user's invoking prompt.
...
Present the inferred classification by pausing and asking the user a focused question:
...
Present the draft to the user in full. Then pause and ask the user a focused question:
