...
- Canonical syntax: `$asset-audit`
- Expected input: `[category|all]`. Input is the text supplied by the user's invoking prompt.
...
Enumerate the target asset directory (for example, with `rg --files`):
