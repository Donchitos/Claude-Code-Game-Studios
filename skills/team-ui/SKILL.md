...
- Canonical syntax: `$team-ui`
- Expected input: `[UI feature description] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
- [ux-designer](../../roles/ux-designer.md) role profile — User flows, wireframes, accessibility, input handling
- [ui-programmer](../../roles/ui-programmer.md) role profile — UI framework, screens, widgets, data binding
- [art-director](../../roles/art-director.md) role profile — Visual style, layout polish, art bible consistency
- configured UI engine specialist role profile — Engine-specific UI pattern validation (e.g., unity-ui-specialist, ue-umg-specialist, godot-specialist)
- [accessibility-specialist](../../roles/accessibility-specialist.md) role profile — Accessibility compliance audit
...
Then pause and ask the user a focused question with options:
