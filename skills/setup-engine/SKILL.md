---
name: setup-engine
description: "Configure the project's game engine and version. Pins the engine in AGENTS.md, detects knowledge gaps, and populates engine reference docs from current official sources when the version is beyond the LLM's training data."
---

## Invocation

- Canonical syntax: `$setup-engine`
- Expected input: `[engine] | [engine version] | refresh | upgrade [old-version] [new-version] | no args for guided selection`. Input is the text supplied by the user's invoking prompt.
...
- [godot-csharp-specialist](../../roles/godot-csharp-specialist.md)
- [godot-gdextension-specialist](../../roles/godot-gdextension-specialist.md)
- [godot-gdscript-specialist](../../roles/godot-gdscript-specialist.md)
- [godot-shader-specialist](../../roles/godot-shader-specialist.md)
- [godot-specialist](../../roles/godot-specialist.md)
- [ue-blueprint-specialist](../../roles/ue-blueprint-specialist.md)
- [ue-gas-specialist](../../roles/ue-gas-specialist.md)
- [ue-replication-specialist](../../roles/ue-replication-specialist.md)
- [ue-umg-specialist](../../roles/ue-umg-specialist.md)
- [unity-addressables-specialist](../../roles/unity-addressables-specialist.md)
- [unity-dots-specialist](../../roles/unity-dots-specialist.md)
- [unity-shader-specialist](../../roles/unity-shader-specialist.md)
- [unity-specialist](../../roles/unity-specialist.md)
- [unity-ui-specialist](../../roles/unity-ui-specialist.md)
- [unreal-specialist](../../roles/unreal-specialist.md)
...
**Question 1 — Prior experience** (ask this first, always, by pausing and asking the user a focused question):
...
**Question 2 — Target platform** (ask this second, always, by pausing and asking the user a focused question — platform eliminates or heavily weights engines before any other factor):
...
5. Pause and ask the user a focused question to confirm: "Does this recommendation feel right, or would you like to explore a different engine?"
...
Pause and ask the user a focused question with concept-specific deep-dive topics. Always generate these options from the user's actual concept — do not use generic options. Always include at minimum:
...
- If no version is provided, check the engine's official release documentation online for the latest stable release:
...
### Remaining Sections
- **Performance Budgets**: Pause and ask the user a focused question:
...
4. Verify uncertain APIs against current official engine documentation online
...
2. Check official engine release and migration documentation online for:
...
Locate and read the official migration guide between
...
- Use `rg` to search for deprecated API names extracted from the migration
...
- NEVER guess an engine version — always verify against current official documentation or user confirmation
...
- If online documentation is ambiguous, show the conflicting results and let the user decide
