...
- Canonical syntax: `$playtest-report`
- Expected input: `[new|analyze path-to-notes] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
After categorising findings, spawn `creative-director` through generic sub-agent delegation using gate **CD-PLAYTEST** (`docs/studio/director-gates.md`).
