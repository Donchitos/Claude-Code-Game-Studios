...
- Canonical syntax: `$team-narrative`
- Expected input: `[narrative content description] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
> Usage: `$team-narrative [narrative content description]` — describe the story content, scene, or narrative area to work on (e.g., `boss encounter cutscene`, `faction intro dialogue`, `tutorial narrative`). Do not pause and ask the user a focused question here; output the guidance directly.
...
- [narrative-director](../../roles/narrative-director.md) role profile — Story arcs, character design, narrative vision
- [writer](../../roles/writer.md) role profile — Dialogue writing, lore entries, in-game text
- [world-builder](../../roles/world-builder.md) role profile — World rules, faction design, history, geography
- [art-director](../../roles/art-director.md) role profile — Character visual profiles, environmental visual storytelling, cinematic tone
- [level-designer](../../roles/level-designer.md) role profile — Level layouts that serve the narrative, pacing
- [localization-lead](../../roles/localization-lead.md) role profile — Localization readiness — flags non-localizable strings, cultural assumptions, and i18n gaps
...
Delegate in parallel — issue all three generic sub-agent requests simultaneously before waiting for any result:
...
sub-agents spawned through generic sub-agent delegation. Each sub-agent enforces the "May I write to [path]?"
