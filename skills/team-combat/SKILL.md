...
- Canonical syntax: `$team-combat`
- Expected input: `[combat feature description] [--review full|lean|solo]`. Input is the text supplied by the user's invoking prompt.
...
- [game-designer](../../roles/game-designer.md) role profile — Design the mechanic, define formulas and edge cases
- [gameplay-programmer](../../roles/gameplay-programmer.md) role profile — Implement the core gameplay code
- [ai-programmer](../../roles/ai-programmer.md) role profile — Implement NPC/enemy AI behavior
- [technical-artist](../../roles/technical-artist.md) role profile — Create VFX, shader effects, visual feedback
- [sound-designer](../../roles/sound-designer.md) role profile — Define audio events, impact sounds, ambient audio
- configured primary engine specialist role profile — Engine idiom validation for architecture and implementation
- [qa-tester](../../roles/qa-tester.md) role profile — Write test cases and validate implementation
