...
- Canonical syntax: `$soak-test`
- Expected input: `[duration: 30m | 1h | 2h | 4h] [focus: memory | stability | balance | all]`. Input is the text supplied by the user's invoking prompt.
