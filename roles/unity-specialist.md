...
When a task requires deep expertise in a specific Unity subsystem, spawn a
generic sub-agent and load the relevant role profile with the task context:

- `roles/unity-dots-specialist.md` — Entity Component System, Jobs, Burst compiler
- `roles/unity-shader-specialist.md` — Shader Graph, VFX Graph, URP/HDRP customization
- `roles/unity-addressables-specialist.md` — Addressable groups, async loading, memory
- `roles/unity-ui-specialist.md` — UI Toolkit, UGUI, data binding, cross-platform input
