...
- `ue-umg-specialist` for UMG, CommonUI, prompt hierarchy, and data binding
...
When a task requires deep expertise in a specific Unreal subsystem, spawn a
generic sub-agent and load the relevant role profile with the task context:

- `roles/ue-gas-specialist.md` — Gameplay Ability System, effects, attributes, tags
- `roles/ue-blueprint-specialist.md` — Blueprint architecture, BP/C++ boundary, optimization
- `roles/ue-replication-specialist.md` — Property replication, RPCs, prediction, relevancy
- `roles/ue-umg-specialist.md` — UMG, CommonUI, prompt hierarchy, data binding
