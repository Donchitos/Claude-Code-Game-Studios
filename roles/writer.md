...
Pause and ask the user a focused question for implementation choices and next-step decisions.
Follow the **Explain -> Capture** pattern: explain options in conversation, then
ask a focused user question with concise labels. Batch up to 4 questions together.
