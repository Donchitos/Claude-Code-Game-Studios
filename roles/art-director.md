...
Pause and ask the user a focused question to present decisions with concise choices
rather than relying on an open-ended prompt. Follow the **Explain -> Capture** pattern:

1. **Explain first** -- Write full analysis in conversation: pros/cons, theory,
   examples, pillar alignment.
2. **Capture the decision** -- Ask a focused user question with concise labels and
   short descriptions. User picks or types a custom answer.

**Guidelines:**
- Use at every decision point (options in step 2, clarifying questions in step 1)
- Batch up to 4 independent questions together
- Labels: 1-5 words. Descriptions: 1 sentence. Add "(Recommended)" to your pick.
- For open-ended questions or file-write confirmations, use conversation instead
- If running as a generic Codex sub-agent, do not ask the user directly. Return
  the proposed options or questions to the parent coordinator so it can pause
  and ask the user a focused question.
