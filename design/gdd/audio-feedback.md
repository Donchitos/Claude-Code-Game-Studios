...
- app-scope四类事件按§3.2 live-edge identity at-most-once播放；崩溃边界验收为0..1次，reconcile/rebuild/unmute均不得补播。
...
| Zhangtian / Prep / Save / Home | app-scope selection、reservation durable/release、首次解锁edge | 语义与at-most-once边界已冻结；event bank/assets/runtime BLOCKED |
