...
> 2026-09-16 Campaign F：首章短关拾取吸引320/600；04每个新线索可见掉落8 XP，08每次阶段突破可见掉落18 XP；容量满合并完整经验量。6/4门槛和180 active tick间隔保持，06及后续章节不改。 见[F证据](../../production/playtest-evidence/2026-09-16-package-f.md)及ADR-0009 F扩展。下方E记录为历史；battle_ready=false。

> 2026-09-16 Campaign E：Campaign首章使用任务级6/4曲线；选择后180 active tick间隔，积压保留在player.xp，终态优先。后七章维持2/1；不替代本文legacy公式。 详见[ADR-0009](../../docs/architecture/adr-0009-chapter-one-pacing-and-view.md)与[E包证据](../../production/playtest-evidence/2026-09-16-package-e.md)。仅本地验证，独立复审待完成，battle_ready=false。
