...
| `cocos-code.md` | `assets/**`, `**/*.ts`, `**/*.effect` | Cocos Creator 3.x: required `@ccclass`/`@property` decorators, asset load/release pairing, platform shims, no hot-updated executable code |
