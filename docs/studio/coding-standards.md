...
This template does not ship a ready-to-run CI workflow. When the project adds
CI, configure it to run the relevant test suite for pull requests and protected
branches.

- Treat failing required tests as a blocking merge condition.
- Never disable or skip failing tests merely to make CI pass.
- Candidate engine-specific CI commands and integrations:
