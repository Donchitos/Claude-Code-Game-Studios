...
4.6, and 4.7 introduced significant changes that the model does NOT know
about. Always cross-reference this directory before suggesting Godot API calls.
...
| 4.7 | Jun 2026 | HIGH | HDR output, AreaLight3D, dedicated MeshLibrary/GridMap editor, DrawableTexture2D, input device ID constants |
